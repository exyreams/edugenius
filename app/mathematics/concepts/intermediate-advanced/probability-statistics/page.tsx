...
const formulas = [
  ...
  {
    id: "measures-of-dispersion-for-grouped-data",
    ...
    text: "text-gray-800 dark:text-white",
    description:
      "Calculate measures of dispersion (range, variance, standard deviation) for grouped data.",
  },
  {
    ...
    gradient:
      "from-teal-200 to-cyan-200 dark:from-teal-600 dark:to-cyan-600",
    text: "text-gray-800 dark:text-white",
    description:
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {formulas.map((formula) => {
          ...
          return (
            <Link
              href={`/mathematics/concepts/intermediate-advanced/probability-statistics/${formula.id}`}
              key={formula.id}
