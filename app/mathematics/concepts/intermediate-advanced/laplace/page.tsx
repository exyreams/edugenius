...
//     { label: "Laplace", href: "/mathematics/formulas/laplace" },
//   ];
//
//   return (
...
//         <h1 className="bg-gradient-to-r from-indigo-700 to-blue-800 bg-clip-text text-4xl font-bold text-transparent sm:text-5xl md:text-6xl dark:from-indigo-300 dark:to-blue-400">
//           Laplace Transforms
//         </h1>
...
//           <Link
//             href={`/mathematics/formulas/laplace/${formula.id}`}
//             key={formula.id}
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        {formulas.map((formula) => {
          ...
          return (
            <Link
              href={`/mathematics/concepts/laplace/${formula.id}`}
              key={formula.id}
