...
/**
 * @component LimitDerivativeAndIntegralOfVectorFunction
 * @description A React component explaining the concepts of limit, derivative, and integral of a vector function in multivariable calculus.
 *              Includes the formula, a brief explanation, and a few practice problems.
 * @returns {JSX.Element} The Limit, Derivative, and Integral of a Vector Function page.
 */
export default function LimitDerivativeAndIntegralOfVectorFunction() {
  /**
  ...
  const breadcrumbItems = [
    ...
    {
      label: "Limit, Derivative, and Integral of a Vector Function",
      href: "/mathematics/concepts/intermediate-advanced/calculus/multivariable/limit-derivative-and-integral-of-vector-function",
    },
  ];
    ...
    <div className="mx-auto w-full px-4 py-8 sm:px-6 md:max-w-7xl md:py-12">
      ...
      <div className="mb-12 space-y-6 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300 md:text-xl">
          Understand the fundamental concepts of calculus for vector functions.
        </p>
      </div>
      ...
      <div className="mt-6 space-y-8">
        ...
        >
          ...
          <div className="mt-4">
            <h3 className={`text-xl font-semibold ${isColorful ? "text-gray-700 dark:text-gray-300" : "text-gray-800 dark:text-gray-200"}`}>Limit of a Vector Function</h3>
            <p
              className={`text-lg ${isColorful ? "text-gray-700 dark:text-gray-300" : "text-gray-800 dark:text-gray-200"}`}
            >
              The limit of a vector function <InlineMath math="\mathbf{r}(t) = \langle f(t), g(t), h(t) \rangle" /> as <InlineMath math="t" /> approaches <InlineMath math="a" /> is given by:
            </p>
            <div
            ...
            >
              <BlockMath math="\lim_{t \to a} \mathbf{r}(t) = \langle \lim_{t \to a} f(t), \lim_{t \to a} g(t), \lim_{t \to a} h(t) \rangle" />
            </div>
            <h3 className={`text-xl font-semibold mt-4 ${isColorful ? "text-gray-700 dark:text-gray-300" : "text-gray-800 dark:text-gray-200"}`}>Derivative of a Vector Function</h3>
            <p
              className={`text-lg ${isColorful ? "text-gray-700 dark:text-gray-300" : "text-gray-800 dark:text-gray-200"}`}
            >
              The derivative of a vector function <InlineMath math="\mathbf{r}(t) = \langle f(t), g(t), h(t) \rangle" /> is given by:
            </p>
            <div
              className={`mt-2 flex justify-start overflow-x-auto ${
                isColorful
            ...
            >
              <BlockMath math="\mathbf{r}'(t) = \langle f'(t), g'(t), h'(t) \rangle" />
            </div>
            <h3 className={`text-xl font-semibold mt-4 ${isColorful ? "text-gray-700 dark:text-gray-300" : "text-gray-800 dark:text-gray-200"}`}>Integral of a Vector Function</h3>
            <p
              className={`text-lg ${isColorful ? "text-gray-700 dark:text-gray-300" : "text-gray-800 dark:text-gray-200"}`}
            >
              The integral of a vector function <InlineMath math="\mathbf{r}(t) = \langle f(t), g(t), h(t) \rangle" /> is given by:
            </p>
            <div
              className={`mt-2 flex justify-start overflow-x-auto ${
                isColorful
            ...
            >
              <BlockMath math="\int \mathbf{r}(t) \,dt = \langle \int f(t) \,dt, \int g(t) \,dt, \int h(t) \,dt \rangle" />
            </div>
          </div>
        </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Find the limit of } \mathbf{r}(t) = \langle \frac{\sin(t)}{t}, t^2, \ln(t+1) \rangle \text{ as } t \to 0." />
                </div>
                <details className="group mt-3">
                  ...
                  >
                    <BlockMath math="\langle 1, 0, 0 \rangle" />
                  </div>
                </details>
              </div>
            </div>
            ...
            <div className={`rounded-lg transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Find the derivative of } \mathbf{r}(t) = \langle t^3, e^{2t}, \cos(t) \rangle." />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
                  ...
                  >
                    <BlockMath math="\mathbf{r}'(t) = \langle 3t^2, 2e^{2t}, -\sin(t) \rangle" />
                  </div>
                </details>
              </div>
            </div>
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Evaluate the integral of } \mathbf{r}(t) = \langle 2t, 3t^2, 4t^3 \rangle." />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
                  ...
                  >
                    <BlockMath math="\langle t^2, t^3, t^4 \rangle + \mathbf{C}" />
                  </div>
                </details>
              </div>
            </div>
        ...
        <div className="mt-16 flex items-center justify-center space-x-4">
          ...
          <span className="text-sm italic text-gray-700 dark:text-gray-200">
            Limit, Derivative, and Integral of a Vector Function in Multivariable Calculus
          </span>
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-gray-600 to-transparent dark:via-gray-400" />
        </div>
      </div>
