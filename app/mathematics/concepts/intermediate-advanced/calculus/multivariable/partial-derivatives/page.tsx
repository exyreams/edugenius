 ...
 * @description A React component explaining the concept of partial derivatives in multivariable calculus.
 *              Includes the formula, a brief explanation, and a few practice problems.
 * @returns {JSX.Element} The Partial Derivatives page.
 */
export default function PartialDerivatives() {
  ...
  const breadcrumbItems = [
    ...
    },
    {
      ...
      href: "/mathematics/concepts/intermediate-advanced/calculus/multivariable/partial-derivatives",
    },
  ];
    ...
    <div className="mx-auto w-full px-4 py-8 sm:px-6 md:max-w-7xl md:py-12">
      ...
      <div className="mb-12 space-y-6 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300 md:text-xl">
          Understand the rate of change of a multivariable function with respect to one variable at a time.
        </p>
      </div>
      ...
      <div className="mt-6 space-y-8">
        ...
        >
          ...
          <div className="mt-4">
            ...
            >
              The partial derivative of a function <InlineMath math="f(x, y)" /> with respect to <InlineMath math="x" /> is denoted by <InlineMath math="\frac{\partial f}{\partial x}" /> or <InlineMath math="f_x" /> and is found by differentiating <InlineMath math="f" /> with respect to <InlineMath math="x" /> while treating <InlineMath math="y" /> as a constant.
            </p>
            <div
            ...
            >
              Similarly, the partial derivative with respect to <InlineMath math="y" /> is:
            </p>
            <div
              className={`mt-2 flex justify-start overflow-x-auto ${
                isColorful
            ...
            >
              <BlockMath math="\frac{\partial f}{\partial y} = \lim_{h \to 0} \frac{f(x, y+h) - f(x, y)}{h}" />
            </div>
          </div>
        </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Find the partial derivatives } \frac{\partial f}{\partial x} \text{ and } \frac{\partial f}{\partial y} \text{ of } f(x, y) = x^2y^3 + x^3y^2." />
                </div>
                <details className="group mt-3">
                  ...
                  >
                    <BlockMath math="\frac{\partial f}{\partial x} = 2xy^3 + 3x^2y^2, \quad \frac{\partial f}{\partial y} = 3x^2y^2 + 2x^3y" />
                  </div>
                </details>
              </div>
            </div>
            ...
            <div className={`rounded-lg transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Find the partial derivatives } \frac{\partial f}{\partial x} \text{ and } \frac{\partial f}{\partial y} \text{ of } f(x, y) = e^{xy} \sin(x)." />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
                  ...
                  >
                    <BlockMath math="\frac{\partial f}{\partial x} = ye^{xy}\sin(x) + e^{xy}\cos(x), \quad \frac{\partial f}{\partial y} = xe^{xy}\sin(x)" />
                  </div>
                </details>
              </div>
            </div>
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Find the partial derivatives } \frac{\partial f}{\partial x}, \frac{\partial f}{\partial y}, \text{ and } \frac{\partial f}{\partial z} \text{ of } f(x, y, z) = x \ln(yz)." />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
                  ...
                  >
                    <BlockMath math="\frac{\partial f}{\partial x} = \ln(yz), \quad \frac{\partial f}{\partial y} = \frac{x}{y}, \quad \frac{\partial f}{\partial z} = \frac{x}{z}" />
                  </div>
                </details>
              </div>
            </div>
