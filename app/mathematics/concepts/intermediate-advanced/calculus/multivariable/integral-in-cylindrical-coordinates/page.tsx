...
export default function IntegralInCylindricalCoordinates() {
  const breadcrumbItems = [
    ...
    {
      label: "Integral in Cylindrical Coordinates",
      href: "/mathematics/concepts/intermediate-advanced/calculus/multivariable/integral-in-cylindrical-coordinates",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">Integral in Cylindrical Coordinates</h1>
