...
/**
 * @component PropertiesOfLimits
 * @description A React component explaining the properties of limits of functions of several variables in multivariable calculus.
 *              Includes the formula, a brief explanation, and a few practice problems.
 * @returns {JSX.Element} The Properties of Limits of Functions of Several Variables page.
 */
export default function PropertiesOfLimits() {
  /**
  ...
  const breadcrumbItems = [
    ...
    {
      label: "Properties of Limits of Functions of Several Variables",
      href: "/mathematics/concepts/intermediate-advanced/calculus/multivariable/properties-of-limits-of-functions-of-several-variables",
    },
  ];
    ...
    <div className="mx-auto w-full px-4 py-8 sm:px-6 md:max-w-7xl md:py-12">
      ...
      <div className="mb-12 space-y-6 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300 md:text-xl">
          Understand the behavior of functions of several variables as they approach a point.
        </p>
      </div>
      ...
      <div className="mt-6 space-y-8">
        ...
        >
          ...
          <div className="mt-4">
            ...
            >
              Let <InlineMath math="\lim_{(x,y) \to (a,b)} f(x,y) = L" /> and <InlineMath math="\lim_{(x,y) \to (a,b)} g(x,y) = M" />. Then the following properties hold:
            </p>
            <ul className="list-disc pl-6 mt-2 text-lg">
              <li>Sum Rule: <InlineMath math="\lim_{(x,y) \to (a,b)} [f(x,y) + g(x,y)] = L + M" /></li>
              <li>Difference Rule: <InlineMath math="\lim_{(x,y) \to (a,b)} [f(x,y) - g(x,y)] = L - M" /></li>
              <li>Constant Multiple Rule: <InlineMath math="\lim_{(x,y) \to (a,b)} [cf(x,y)] = cL" /></li>
              <li>Product Rule: <InlineMath math="\lim_{(x,y) \to (a,b)} [f(x,y)g(x,y)] = LM" /></li>
              <li>Quotient Rule: <InlineMath math="\lim_{(x,y) \to (a,b)} \frac{f(x,y)}{g(x,y)} = \frac{L}{M}" />, if <InlineMath math="M \neq 0" /></li>
              <li>Power Rule: <InlineMath math="\lim_{(x,y) \to (a,b)} [f(x,y)]^n = L^n" />, where n is a positive integer.</li>
            </ul>
          </div>
        </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Evaluate } \lim_{(x,y) \to (1,2)} (x^2y + 3x - 2y)." />
                </div>
            ...
            <div className={`rounded-lg transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Evaluate } \lim_{(x,y) \to (0,0)} \frac{x^2 - y^2}{x+y}." />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Evaluate } \lim_{(x,y) \to (1,1)} \frac{x^2 - y^2}{x-y}." />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
        ...
        <div className="mt-16 flex items-center justify-center space-x-4">
          ...
          <span className="text-sm italic text-gray-700 dark:text-gray-200">
            Properties of Limits of Functions of Several Variables in Multivariable Calculus
          </span>
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-gray-600 to-transparent dark:via-gray-400" />
        </div>
      </div>
