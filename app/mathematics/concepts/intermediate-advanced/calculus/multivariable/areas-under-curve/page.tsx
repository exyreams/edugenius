...
/**
 * @component AreasUnderCurve
 * @description A React component explaining the concept of areas under a curve in multivariable calculus.
 *              Includes the formula, a brief explanation, and a few practice problems.
 * @returns {JSX.Element} The Areas Under a Curve page.
 */
export default function AreasUnderCurve() {
  /**
  ...
  const breadcrumbItems = [
    ...
    { label: "Calculus", href: "/mathematics/concepts/intermediate-advanced/calculus" },
    { label: "Multivariable", href: "/mathematics/concepts/intermediate-advanced/calculus/multivariable" },
    { label: "Areas Under a Curve", href: "/mathematics/concepts/intermediate-advanced/calculus/multivariable/areas-under-curve" },
  ];
    ...
    <div className="mx-auto w-full px-4 py-8 sm:px-6 md:max-w-7xl md:py-12">
      ...
      <div className="mb-12 space-y-6 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300 md:text-xl">
          Calculate the area of a region in a plane using integration.
        </p>
      </div>
      ...
      <div className="mt-6 space-y-8">
        ...
        >
          ...
          <div className="mt-4">
            ...
            >
              The area of the region bounded by the curves <InlineMath math="y = f(x)" /> and <InlineMath math="y = g(x)" /> from <InlineMath math="x = a" /> to <InlineMath math="x = b" />, where <InlineMath math="f(x) \ge g(x)" /> for all <InlineMath math="x" /> in <InlineMath math="[a, b]" />, is given by:
            </p>
            <div
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Find the area of the region bounded by } y = x^2 \text{ and } y = \sqrt{x}." />
                </div>
            ...
            <div className={`rounded-lg transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Find the area of the region bounded by } y = e^x, y = x, x = 0, \text{ and } x = 1." />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${isColorful ? "text-gray-700 hover:text-green-600 dark:text-white dark:hover:text-green-300" : "text-gray-700 dark:text-gray-300"}`}
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math="\text{Find the area of the region bounded by } y = \sin(x), y = \cos(x), x = 0, \text{ and } x = \frac{\pi}{4}." />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${isColorful ? "text-gray-700 hover:text-green-600 dark:text-white dark:hover:text-green-300" : "text-gray-700 dark:text-gray-300"}`}
        ...
        <div className="mt-16 flex items-center justify-center space-x-4">
          ...
          <span className="text-sm italic text-gray-700 dark:text-gray-200">
            Areas Under a Curve in Multivariable Calculus
          </span>
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-gray-600 to-transparent dark:via-gray-400" />
        </div>
      </div>
