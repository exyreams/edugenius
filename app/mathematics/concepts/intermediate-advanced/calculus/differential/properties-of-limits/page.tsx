...
/**
 * @component LimitProperties
 * @description A React component that explains the properties of limits in calculus,
 *              including fundamental limit laws, special limits, continuity, and L'Hôpital's Rule.
 * @returns {JSX.Element} The Limit Properties page.
 */
export default function LimitProperties() {
  ...
  const breadcrumbItems = [
    ...
    },
    {
      ...
      href: "/mathematics/concepts/intermediate-advanced/calculus/differential/properties-of-limits",
    },
  ];
    ...
    <div className="mx-auto w-full px-4 py-8 sm:px-6 md:max-w-7xl md:py-12">
      ...
      <div className="mb-12 space-y-6 text-center">
        ...
        <p className="mx-auto max-w-3xl text-lg text-gray-600 dark:text-gray-300 md:text-xl">
          Master the fundamental properties of limits, including limit laws,
          special limits, continuity, and L&#39;Hôpital&#39;s Rule, to evaluate
          ...
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              >
                ...
                >
                  If <InlineMath math="\lim_{x \to a} f(x) = L" /> and{" "}
                  <InlineMath math="\lim_{x \to a} g(x) = M" />, then the limit
                  of their sum is the sum of their limits.
                </p>
              </div>
              <div
                className={`rounded-lg p-4 ${
              ...
              >
                ...
                >
                  <BlockMath
                    math={"\\lim_{x \\to a} [f(x) \\cdot g(x)] = L \\cdot M"}
                  />
                </div>
                <p
                  className={`mt-2 ${
                ...
                >
                  If <InlineMath math="\lim_{x \to a} f(x) = L" /> and{" "}
                  <InlineMath math="\lim_{x \to a} g(x) = M" />, then the limit
                  of their product is the product of their limits
                </p>
              </div>
            </div>
            <div className="space-y-4">
              ...
              >
                ...
                >
                  If <InlineMath math="\lim_{x \to a} f(x) = L" /> and{" "}
                  <InlineMath math="\lim_{x \to a} g(x) = M \neq 0" />, then the
                  limit of their quotient is the quotient of their limits.
                </p>
              </div>
              <div
                className={`rounded-lg p-4 ${
              ...
              >
                ...
                >
                  If <InlineMath math="\lim_{x \to a} f(x) = L" />, then the
                  limit of the function raised to a power n is the limit raised
                  to that power.
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  A function <InlineMath math="f" /> is continuous at a point{" "}
                  <InlineMath math="a" /> if the limit of{" "}
                  <InlineMath math="f(x)" /> as <InlineMath math="x" />{" "}
                  approaches <InlineMath math="a" /> is equal to the
                  function&#39;s value at <InlineMath math="a" />.
                </p>
              </div>
              <div
                className={`rounded-lg p-4 ${
              ...
              >
                ...
                >
                  <BlockMath
                    math={
                      "\\text{If } f \\text{ and } g \\text{ are continuous, then } f \\circ g \\text{ is continuous}"
                    }
                  />
                </div>
                <p
                ...
                >
                  If functions <InlineMath math="f" /> and{" "}
                  <InlineMath math="g" /> are continuous, then their composition{" "}
                  <InlineMath math="f \circ g" /> is also continuous.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  <BlockMath
                    math={
                      "\\text{For } \\frac{0}{0} \\text{ or } \\frac{\\infty}{\\infty} \\text{ forms}"
                    }
                  />
                </div>
                <div
                ...
                >
                  If the limit of <InlineMath math="\frac{f(x)}{g(x)}" /> as{" "}
                  <InlineMath math="x" /> approaches <InlineMath math="a" />{" "}
                  results in an indeterminate form of{" "}
                  <InlineMath math="\frac{0}{0}" /> or{" "}
                  <InlineMath math="\frac{\infty}{\infty}" />, then the limit is
                  equal to the limit of the quotient of their derivatives,
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  ...
                  <InlineMath math="\lim_{x \to 0} \frac{\sin x}{x}" /> , we
                  differentiate the numerator and denominator to get{" "}
                  <InlineMath math="\lim_{x \to 0} \frac{\cos x}{1}" />, which
                  evaluates to 1.
                </p>
              </div>
            </div>
        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              >
                <BlockMath math={"\\lim_{x \\to 3} (2x + 5)"} />
              </div>
            ...
            >
              ...
              >
                <BlockMath math={"\\lim_{x \\to 4} \\frac{x^2 - 16}{x - 4}"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\lim_{x \\to 1} \\frac{x^3 - 1}{x - 1}"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\lim_{x \\to 0} \\frac{\\tan x - x}{x^3}"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
