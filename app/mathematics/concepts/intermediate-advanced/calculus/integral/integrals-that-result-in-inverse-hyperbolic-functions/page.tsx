...
export default function IntegralThatResultInInverseHyperbolicFunctions() {
  const breadcrumbItems = [
    ...
    {
      label: "Integrals that Result in Inverse Hyperbolic Functions",
      href: "/mathematics/formulas/calculus/integral/integrals-that-result-in-inverse-hyperbolic-functions",
    },
  ];
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">
        Integrals that Result in Inverse Hyperbolic Functions
      </h1>
