...
/**
 * @component IntegrationByParts
 * @description A React component explaining the Integration by Parts technique in calculus.
 *              Includes the formula, explanation, a worked example, and practice problems.
 * @returns {JSX.Element} The Integration by Parts page.
 */
export default function IntegrationByParts() {
  ...
  const breadcrumbItems = [
    ...
    },
    {
      ...
      href: "/mathematics/concepts/intermediate-advanced/calculus/integral-calculus/integration-by-parts",
    },
  ];
    ...
    <div className="mx-auto w-full px-4 py-8 sm:px-6 md:max-w-7xl md:py-12">
      ...
      <div className="mb-12 space-y-6 text-center">
        ...
        <p className="mx-auto max-w-3xl text-lg text-gray-600 dark:text-gray-300 md:text-xl">
          Master the integration by parts technique, a powerful method for
          integrating products of functions, derived from the product rule for
          differentiation.
        </p>
      </div>
      ...
      <div className="mt-6 space-y-8">
        ...
        >
          ...
          >
            Integration by Parts is a technique for evaluating integrals of the
            form <InlineMath math="\int f(x)g(x) \, dx" />. It is derived from
            the product rule for differentiation. The formula is applied by
            carefully choosing parts of the integrand to represent{" "}
            <InlineMath math="u" /> and <InlineMath math="dv" />.
          </p>
          <h3
          ...
          >
            The choice of <InlineMath math="u" /> and <InlineMath math="dv" />{" "}
            is crucial. A helpful mnemonic is &#34;LIATE&#34;:
          </p>
          <ul
          ...
          >
            <li>
              <strong>L</strong>ogarithmic functions
            </li>
            <li>
              <strong>I</strong>nverse trigonometric functions
            </li>
            <li>
              <strong>A</strong>lgebraic functions
            </li>
            <li>
              <strong>T</strong>rigonometric functions
            </li>
            <li>
              <strong>E</strong>xponential functions
            </li>
          </ul>
          <p
            className={`mt-2 ${
          ...
          >
            Generally, choose <InlineMath math="u" /> to be the function that
            comes earlier in this list. This is a guideline, not a strict rule,
            and sometimes you may need to experiment. The goal is to make the
            integral <InlineMath math="\int v \, du" /> simpler than the
            original integral.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <InlineMath math="\int x \sin(x) \, dx" /> using integration by
            parts.
          </p>
          <ol
            className={`mt-2 list-decimal space-y-2 pl-6  ${
              isColorful
                ? "text-gray-700 dark:text-gray-300"
                : "text-gray-700 dark:text-gray-300"
            }`}
          >
            <li>
              Choose <InlineMath math="u = x" /> (algebraic) and{" "}
              <InlineMath math="dv = \sin(x) \, dx" /> (trigonometric).
            </li>
            <li>
              Compute <InlineMath math="du = dx" /> and{" "}
              <InlineMath math="v = -\cos(x)" />.
            </li>
            <li>
              Apply the formula:
              <BlockMath math="\int x \sin(x) \, dx = -x\cos(x) - \int (-\cos(x)) \, dx" />
            </li>
            <li>
          ...
          >
            <BlockMath
              math={"\\int x \\sin(x) \\, dx = -x\\cos(x) + \\sin(x) + C"}
            />
          </div>
        </div>
        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              >
                <BlockMath math={"\\int x^2 \\ln(x) \\, dx"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
                ...
                >
                  <BlockMath
                    math={"\\frac{x^3}{3}\\ln(x) - \\frac{x^3}{9} + C"}
                  />
                </div>
              </details>
            </div>
            ...
            >
              ...
              <details className="group mt-3">
                ...
                >
                  <BlockMath math={"x \\sin(x) + \\cos(x) + C"} />
                </div>
              </details>
            </div>
            ...
            >
              ...
              <details className="group mt-3">
                ...
                >
                  <BlockMath math={"x^2e^x - 2xe^x + 2e^x + C"} />
                </div>
              </details>
            </div>
            ...
            >
              ...
              >
                <BlockMath math={"\\int e^x \\cos(x) \\, dx"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
                ...
                >
                  <BlockMath
                    math={"\\frac{1}{2}e^x(\\sin(x) + \\cos(x)) + C"}
                  />
                </div>
              </details>
            </div>
