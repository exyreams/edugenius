...
export default function IntegrationByTrigonometricSubstitution() {
  const breadcrumbItems = [
    ...
    {
      label: "Integration by Trigonometric Substitution",
      href: "/mathematics/formulas/calculus/integral/integration-by-trigonometric-substitution",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">Basic Integration Rules</h1>
