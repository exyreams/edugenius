...
/**
 * @component BasicIntegrationRules
 * @description A React component explaining basic integration rules in calculus.  Covers
 *              fundamental rules like the power rule, constant multiple rule, sum/difference
 *              rule, and common integrals of elementary functions. Includes examples and
 *              practice problems with solutions.
 * @returns {JSX.Element} The Basic Integration Rules page.
 */
export default function BasicIntegrationRules() {
  /**
  ...
  const breadcrumbItems = [
    ...
    },
    {
      ...
      href: "/mathematics/concepts/intermediate-advanced/calculus/integral/basic-integration-rules",
    },
  ];
    ...
    <div className="mx-auto w-full px-4 py-8 sm:px-6 md:max-w-7xl md:py-12">
      ...
      <div className="mb-12 space-y-6 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300 md:text-xl">
          Learn the fundamental rules of integral calculus, including the power
          rule, constant multiple rule, sum and difference rules, and integrals
          of common functions.
        </p>
      </div>
          ...
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              >
                ...
                >
                  The power rule states that the integral of x raised to the
                  power of n is x raised to the power of (n+1), divided by
                  (n+1), plus the constant of integration C. This rule applies
                  for all n ≠ -1.
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <p
                  className={`mt-2 ${isColorful ? "text-gray-600 dark:text-gray-300" : "text-gray-700 dark:text-gray-300"}`}
                >
                  The integral of a sum or difference of functions is the sum or
              ...
              >
                ...
                >
                  <BlockMath math="\int a \, dx = ax + C" />
                </div>
                <p
                  className={`mt-2 ${isColorful ? "text-gray-600 dark:text-gray-300" : "text-gray-700 dark:text-gray-300"}`}
                >
                  The integral of a constant &#39;a&#39; with respect to x is
          ...
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              >
                ...
                >
                  The integral of exponential function is itself.
                </p>
                <div
                  className={`mt-2 flex justify-start overflow-x-auto ${
                    isColorful
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  <BlockMath math="\int \csc^2(x) dx = -\cot(x) + C" />
                </div>
                <p
                  className={`mt-2 ${
                    isColorful
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math={"\\int (3x^2 + 2x - 1) dx"} />
                </div>
            ...
            <div className={`rounded-lg transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math={"\\int (4\\cos x - 3\\sin x) dx"} />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
                  ...
                  >
                    <BlockMath math="4\\sin x + 3\\cos x + C" />
                  </div>
                </details>
              </div>
            </div>
            ...
            <div className={`rounded-lg transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math={"\\int \\frac{5}{x} dx"} />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math={"\\int (e^x + \\frac{1}{x}) dx"} />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            <div className={`rounded-lg transition-all hover:shadow-lg`}>
              <div
                className={`rounded-lg p-4 ${
                  isColorful
                    ? `bg-gradient-to-br ${getProblemColor(4)}`
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math={"\\int 2\\sec^2 x \\, dx"} />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math={"\\int (\\frac{1}{x} + e^x) dx"} />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <details className="group mt-3">
                  ...
                  >
                    <BlockMath math={"\\frac{5^x}{\\ln 5} + C"} />
                  </div>
                </details>
              </div>
            </div>
            ...
            <div className={`rounded-lg transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math={"\\int (\\csc^2 x + \\sec^2 x) dx"} />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            <div className={`rounded-lg  transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math={"\\int \\frac{3x}{x^2 + 1} dx"} />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
                  ...
                  >
                    <BlockMath math="\\frac{3}{2} \\ln |x^2 + 1| + C" />
                  </div>
                </details>
              </div>
            </div>
            ...
            <div className={`rounded-lg transition-all hover:shadow-lg`}>
              ...
              >
                ...
                <div className={`mt-2 flex justify-start overflow-x-auto`}>
                  <BlockMath math={"\\int (2\\cos x - \\frac{1}{x} + 5) dx"} />
                </div>
                <details className="group mt-3">
                  <summary
                    className={`flex cursor-pointer items-center text-sm font-medium ${
                  ...
                  >
                    <BlockMath math="{2\\sin x - \\ln|x| + 5x + C}" />
                  </div>
                </details>
              </div>
            </div>
