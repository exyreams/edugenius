...
export default function IntegralsThatResultInverseTrigonometricFunctions() {
  const breadcrumbItems = [
    ...
    {
      label: "Integrals that Result in Inverse Trigonometric Functions",
      href: "/mathematics/formulas/calculus/integral/integrals-that-result-in-inverse-trigonometric-functions",
    },
  ];
