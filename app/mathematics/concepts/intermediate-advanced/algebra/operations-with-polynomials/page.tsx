...
/**
 * @component OperationsWithPolynomials
 * @description A React component providing an in-depth explanation of operations with polynomials.
 * @returns {JSX.Element} The Polynomial Operations page.
 */
export default function OperationsWithPolynomials() {
  /**
  ...
  const breadcrumbItems = [
    ...
    },
    {
      ...
      href: "/mathematics/concepts/intermediate-advanced/algebra/polynomial-operations",
    },
  ];
    ...
    <div className="mx-auto w-full px-4 py-8 sm:px-6 md:max-w-7xl md:py-12">
      ...
      <div className="mb-12 space-y-6 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300 md:text-xl">
          Explore addition, subtraction, multiplication, division, and factoring
          of polynomials with detailed explanations and examples.
        </p>
      </div>
      ...
      <div className="mt-6 space-y-8">
        ...
        <div
          className={`${
            isColorful
              ? "bg-gradient-to-br from-violet-100 to-purple-200 dark:from-violet-700 dark:to-purple-800"
              : "glass"
          ...
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              >
                ...
                >
                  <BlockMath
                    math={"(3x^2 + 2x - 5) + (2x^2 - 4x + 1) = 5x^2 - 2x - 4"}
                  />
                </div>
                <p
                  className={`mt-2 ${
                ...
                >
                  To add or subtract polynomials, combine *like terms*. Like
              ...
              >
                ...
                >
                  Multiply polynomials using the distributive property. For
                  binomials, the FOIL method (First, Outer, Inner, Last) is a
                  helpful mnemonic.
                </p>
              </div>
            </div>
            <div className="space-y-4">
              ...
              >
                ...
                >
                  <BlockMath
                    math={"\\frac{6x^3 - 5x^2 + 4}{2x + 1} = 3x^2 - 4x + 2"}
                  />
                </div>
                <p
                  className={`mt-2 ${
                ...
                >
                  Polynomial long division is similar to long division with
                  numbers. Synthetic division is a shortcut method applicable
                  when dividing by a linear binomial of the form{" "}
                  <InlineMath math={"x - a"} />.
                </p>
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  It involves finding expressions that, when multiplied
                  together, produce the original polynomial.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              >
                ...
                <div
                  className={`h-auto overflow-x-auto rounded-lg  p-4 ${
                    isColorful
                      ? "scrollbar-thin scrollbar-track-cyan-200 scrollbar-thumb-cyan-300  dark:scrollbar-track-cyan-600 dark:scrollbar-thumb-cyan-500"
                      : "scrollbar-thin scrollbar-track-gray-200 scrollbar-thumb-gray-300 dark:scrollbar-track-gray-400 dark:scrollbar-thumb-gray-500"
                  }`}
              ...
              >
                ...
                >
                  A specific application of the distributive property for
                  multiplying two binomials: First, Outer, Inner, Last.
                </p>
              </div>
            </div>
            <div className="space-y-4">
              ...
              >
                ...
                >
                  <div
                    className={`font-mono text-sm md:text-base ${isColorful ? "text-gray-700 dark:text-gray-300" : "text-gray-700 dark:text-gray-300"}`}
                  >
                    <BlockMath>
                      {`
                    \\begin{array}{r}
                ...
                >
                  Similar to multiplying multi-digit numbers, this method
                  organizes the multiplication vertically.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              >
                ...
                >
                  Find the largest factor that divides all terms of the
                  polynomial.
                </p>
              </div>
              <div
              ...
              >
                ...
                >
                  Applies to binomials where both terms are perfect squares and
                  are subtracted.
                </p>
              </div>
            </div>
            <div className="space-y-4">
              ...
              >
                ...
                >
                  ...
                  <InlineMath math={"ax^2 + bx + c"} />, find two numbers that
                  multiply to <InlineMath math={"ac"} /> and add to{" "}
                  <InlineMath math={"b"} />.
                </p>
              </div>
              <div
              ...
              >
                ...
                >
                  <BlockMath
                    math={"2x^3 + 4x^2 + 3x + 6 = (2x^2 + 3)(x + 2)"}
                  />
                </div>
                <p
                  className={`mt-2 ${
                ...
                >
                  Used for polynomials with four or more terms. Group terms,
                  factor out the GCF from each group, and then factor out the
            ...
            <div className="flex justify-center">
              ...
              >
                ...
                <path
                  ...
                  fill="none"
                  stroke={isColorful ? "#f43f5e" : "gray"}
                  strokeWidth="2"
                />
                <text x="110" y="90" fontSize="12" textAnchor="middle">
                  Degree 2 Polynomial
                </text>
                <text x="10" y="190" fontSize="12">
                  Roots
                </text>
                <text x="160" y="190" fontSize="12">
                  Roots
                </text>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  <BlockMath
                    math={
                      "\\text{Degree } n \\Rightarrow \\text{At most } n \\text{ roots}"
                    }
                  />
                </div>
                <p
                ...
                >
                  A polynomial of degree <InlineMath math={"n"} /> can have at
                  most <InlineMath math={"n"} /> real roots (x-intercepts).
                </p>
                <div
                  className={`mt-2 h-auto overflow-x-auto rounded-lg  p-4 ${
                    isColorful
                ...
                >
                  <BlockMath
                    math={"\\text{Leading coefficient determines end behavior}"}
                  />
                </div>
                ...
                >
                  The sign of the leading coefficient determines the end
                  behavior of the graph (whether it rises or falls as{" "}
                  <InlineMath math={"x"} /> approaches positive or negative
                  infinity).
                </p>
              </div>
            </div>
        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              >
                <BlockMath
                  math={"\\text{Add: } (3x^2 - 2x + 5) + (x^2 + 4x - 3)"}
                />
              </div>
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Multiply: } (x + 3)(x - 4)"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Factor: } x^2 - 7x + 10"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Divide: } (x^3 - 8) ÷ (x - 2)"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Expand: } (2x - 5)^2"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath
                  math={"\\text{Simplify: } 3x(x^2 - 4) - 2(x^3 - 3x)"}
                />
              </div>
              <details className="group mt-3">
                <summary
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Factor: } 6x^2 - 13x + 6"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Multiply: } (x + 2)(x^2 - 3x + 1)"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Find roots: } x^2 + 6x + 8 = 0"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Special product: } (a + b)(a - b)"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath
                  math={"\\text{Divide: } (4x^4 - 3x^2 + 2) ÷ (x - 1)"}
                />
              </div>
              <details className="group mt-3">
                <summary
                ...
                >
                  <BlockMath math={"4x^3 + 4x^2 + x + 1 + \\frac{3}{x-1}"} />
                </div>
              </details>
            </div>
            {/* Problem 12 */}
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Factor: } 9x^2 - 25y^2"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
