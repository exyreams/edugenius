...
/**
 * @component ProductFormulas
 * @description A comprehensive guide to algebraic product formulas, including fundamental formulas, special products, geometric interpretations, applications, and practice exercises.
 * @returns {JSX.Element} The Product Formulas page.
 */
export default function ProductFormulas() {
  ...
  const breadcrumbItems = [
    ...
    },
    {
      ...
      href: "/mathematics/concepts/intermediate-advanced/algebra/product-formulas",
    },
  ];
    ...
    <div className="mx-auto w-full px-4 py-8 sm:px-6 md:max-w-7xl md:py-12">
      ...
      <div className="mb-12 space-y-6 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300 md:text-xl">
          Unlock the power of algebraic manipulation with essential product
          formulas.
        </p>
      </div>
      ...
      <div className="mt-6 space-y-8">
        ...
        >
          ...
          >
            Fundamental Product Formulas: The Building Blocks
          </h2>
          <p
            className={`mt-2  ${
              isColorful
          ...
          >
            Product formulas are essential tools for expanding and factoring
            algebraic expressions. They provide shortcuts for multiplying
            certain types of expressions, and they&#39;re also crucial for
            factoring, which is the reverse process.
          </p>
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              >
                ...
                >
                  This is the most fundamental product formula. It states that
                  multiplying a single term by a sum (or difference) is the same
                  as multiplying the single term by each term in the sum (or
                  difference) and then adding (or subtracting) the results. This
                  can be extended to more than two terms inside the parentheses.
                </p>
                <p
                ...
                >
                  <BlockMath math="2(x + 3) = 2x + 6" />
                  <BlockMath math="x(y - z + 5) = xy - xz + 5x" />
                </div>
              </div>
              ...
              >
                ...
                >
                  <span className="text-xl font-bold">FOIL</span> is a mnemonic
                  for multiplying two binomials (expressions with two terms). It
                  stands for:
                </p>
                <ul
                ...
                >
                  <li>
                    <span className="text-xl font-bold">F</span>irst: Multiply
                    the first terms of each binomial (
                    <InlineMath math="ac" />)
                  </li>
                  <li>
                    <span className="text-xl font-bold">O</span>uter: Multiply
                    the outer terms of the product (
                    <InlineMath math="ad" />)
                  </li>
                  <li>
                    <span className="text-xl font-bold">I</span>nner: Multiply
                    the inner terms of the product (
                    <InlineMath math="bc" />)
                  </li>
                  <li>
                    <span className="text-xl font-bold">L</span>ast: Multiply
                ...
                >
                  Then, combine any like terms. FOIL is essentially a specific
                ...
                >
                  <BlockMath math="(x + 2)(x - 3) = x^2 - 3x + 2x - 6 = x^2 - x - 6" />
                </div>
              </div>
            </div>
            <div>
              {/* General Product of Polynomials */}
              <div
                className={`rounded-lg p-4 ${
                  isColorful
                    ? "bg-black/5 backdrop-blur-sm dark:bg-black/20"
              ...
              >
                ...
                >
                  To multiply any two polynomials, distribute each term of the
                  first polynomial to every term of the second polynomial. Then
                  combine like terms.
                </p>
                <p
                  className={`mt-2 font-bold italic ${
                ...
                >
                  <BlockMath math="(x + 1)(x^2 - x + 2) = x(x^2-x+2) + 1(x^2 - x + 2)" />
                  <BlockMath math="= x^3 - x^2 + 2x + x^2 -x + 2 = x^3 + x + 2" />
                </div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            Special Product Formulas: Shortcuts for Common Patterns
          </h2>
          <p
            className={`mt-2 ${
              isColorful
          ...
          >
            Certain polynomial products appear so frequently that it&#39;s worth
            memorizing their formulas. These &#34;special products&#34; greatly
            speed up both expansion and factoring.
          </p>
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              >
                ...
                >
                  The difference of the squares of two terms factors into the
                  product of the sum and difference of those terms. This is one
                  of the most commonly used factoring patterns.
                </p>
                <p
                  className={`mt-2 font-bold italic ${
                    isColorful
                ...
                >
                  ...
                  <BlockMath math="4y^2 - 25 = (2y - 5)(2y + 5)" />
                </div>
              </div>
              ...
              >
                ...
                >
                  These formulas provide a way to factor expressions involving
                  the sum or difference of two cubes. Note the patterns in the
                  signs.
                </p>
                <p
                  className={`mt-2 font-bold italic ${
                ...
                >
                  <BlockMath math="x^3 + 8 = (x + 2)(x^2 - 2x + 4)" />
                  <BlockMath math="27y^3 - 1 = (3y - 1)(9y^2 + 3y + 1)" />
                </div>
              </div>
            </div>
            <div className="space-y-4">
              ...
              >
                ...
                >
                  The square of a binomial results in a perfect square
                  trinomial. The pattern is: square the first term, add/subtract
                  twice the product of the two terms, and add the square of the
                  last term.
                </p>
                <p
                  className={`mt-2  font-bold italic ${
                ...
                >
                  <BlockMath math="(x + 3)^2 = x^2 + 6x + 9" />
                  <BlockMath math="(2y - 1)^2 = 4y^2 - 4y + 1" />
                </div>
              </div>
              ...
              >
                ...
                >
                  The cube of a binomial expands to a four-term polynomial. Pay
                  close attention to the coefficients and signs.
                </p>
                <p
                  className={`mt-2 font-bold italic ${
                    isColorful
                ...
                >
                  <BlockMath math="(x - 2)^3 = x^3 - 6x^2 + 12x - 8" />
                </div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            Geometric Interpretations of Product Formulas
          </h2>
          <p
            className={`mt-2 ${
              isColorful
          ...
          >
            Many product formulas have visual, geometric interpretations,
            especially those involving squares and cubes. These interpretations
            can aid in understanding and remembering the formulas.
          </p>
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex justify-center">
              ...
              >
                ...
                <text x="100" y="195" fontSize="12">
                  a + b
                </text>
                <text x="5" y="100" fontSize="12" transform="rotate(-90 5,100)">
                  a + b
                </text>
              </svg>
            </div>
            <div className="space-y-4">
              ...
              >
                <li>
                  The large square has sides of length{" "}
                  <InlineMath math="(a + b)" />, so its area is{" "}
                  <InlineMath math="(a + b)^2" />.
                </li>
                <li>
                  The large square is composed of a smaller square with area{" "}
                  <InlineMath math="a^2" />, another smaller square with area{" "}
                  <InlineMath math="b^2" />, and two rectangles, each with area{" "}
                  <InlineMath math="ab" />.
                </li>
                <li>
                  Therefore, the total area can also be expressed as{" "}
                  <InlineMath math="a^2 + ab + ab + b^2 = a^2 + 2ab + b^2" />.
                </li>
              </ul>
              <div
                className={`mt-2 h-auto overflow-x-auto rounded-lg p-4 ${
        ...
        >
          ...
          >
            Key Applications of Product Formulas
          </h2>
          <p
            className={`mt-2  ${
              isColorful
          ...
          >
            Product formulas are used extensively in various areas of algebra
            and beyond:
          </p>
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              >
                ...
                >
                  Quickly expanding products of polynomials, as shown in
                  previous examples.
                </p>
                <div
                  className={`mt-2 h-auto overflow-x-auto rounded-lg  p-4 ${
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  Recognizing special product patterns allows for rapid
                  factoring of expressions, which is essential for solving
                  equations, simplifying expressions, and working with rational
                  expressions.
                </p>
                <div
                  className={`mt-2 h-auto overflow-x-auto rounded-lg  p-4 ${
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  Simplifying complex algebraic expressions often involves using
                  product formulas to expand or factor terms, leading to
                  cancellations and a simpler final form.
                </p>
                <p
                  className={`mt-2  font-bold italic ${
                    isColorful
                ...
                >
                  <BlockMath math="\frac{x^2 - 9}{x+3} = \frac{(x-3)(x+3)}{x+3} = x - 3, x \neq -3" />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  Many algebraic equations can be solved by factoring one or
                  both sides using product formulas and then applying the zero
                  product property (if ab=0, then a=0 or b=0).
                </p>
                <p
                  className={`mt-2  font-bold italic ${
                    isColorful
                ...
                >
                  <BlockMath math="x^2 - 4 = 0  \Rightarrow (x-2)(x+2) = 0 \Rightarrow x = 2 \text{ or } x = -2" />
                </div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            Practice Exercises: Master Product Formulas
          </h2>
          <p
            className={`mt-2  ${
              isColorful
          ...
          >
            Test your understanding and skills with these practice problems.
            Solutions are provided, but try to solve them yourself first!
          </p>
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Expand } (x + 5)(x - 5)"} />
              </div>
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Multiply } (2a - 3b)^2"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Factor } 27x^3 + 8"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Expand } (p + q + r)^2"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
                ...
                >
                  <BlockMath math="p^2 + q^2 + r^2 + 2pq + 2pr + 2qr" />
                </div>
              </details>
            </div>
            ...
            >
              ...
              >
                <BlockMath
                  math={"\\text{Simplify } (3 + \\sqrt{2})(3 - \\sqrt{2})"}
                />
              </div>
              <details className="group mt-3">
                <summary
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Multiply } (x^2 - x + 1)(x + 2)"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Factor } 16y^4 - 81"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
                ...
                >
                  <BlockMath math="(4y^2 - 9)(4y^2 + 9) = (2y - 3)(2y + 3)(4y^2 + 9)" />
                </div>
              </details>
            </div>
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Expand } (1 + i)^3"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
            ...
            >
              ...
              >
                <BlockMath
                  math={"\\text{Find product } (a + b)(a^2 - ab + b^2)"}
                />
              </div>
              <details className="group mt-3">
                <summary
            ...
            >
              ...
              >
                <BlockMath
                  math={"\\text{Simplify } (\\sqrt{a} + \\sqrt{b})^2"}
                />
              </div>
              <details className="group mt-3">
                <summary
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Multiply } (2x - 5)(3x^2 + x - 4)"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
                ...
                >
                  <BlockMath math="6x^3 - 13x^2 - 13x + 20" />
                </div>
              </details>
            </div>
            ...
            >
              ...
              >
                <BlockMath math={"\\text{Factor } x^6 - y^6"} />
              </div>
              <details className="group mt-3">
                <summary
                  className={`flex cursor-pointer items-center text-sm font-medium ${
