...
export default function LawsOfSines() {
  const breadcrumbItems = [
    ...
    {
      label: "Law of Sines",
      href: "/mathematics/formulas/trigonometry/spherical-trigonometry/law-of-sines",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">Law of Sines</h1>
