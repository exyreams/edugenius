...
export default function OtherTrigonometricIdentities() {
  const breadcrumbItems = [
    { label: "Mathematics", href: "/mathematics" },
    { label: "Formulas", href: "/mathematics/" },
    { label: "Trigonometry", href: "/mathematics/formulas/trigonometry" },
    {
      label: "Other Trigonometric Identities",
      href: "/mathematics/formulas/trigonometry/other-trigonometric-identities",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">Other Trigonometric Identities</h1>
