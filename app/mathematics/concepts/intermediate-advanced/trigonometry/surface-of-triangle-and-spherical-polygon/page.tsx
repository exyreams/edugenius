...
export default function SurfaceOfTriangleAndSphericalPolygon() {
  const breadcrumbItems = [
    ...
    {
      label: "Surface of a Triangle and a Spherical Polygon",
      href: "/mathematics/formulas/trigonometry/surface-of-triangle-and-spherical-polygon",
    },
  ];
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">
        Surface of a Triangle and a Spherical Polygon
      </h1>
