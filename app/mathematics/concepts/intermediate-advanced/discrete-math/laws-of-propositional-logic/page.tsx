...
export default function LawsOfPropositionalLogic() {
  const breadcrumbItems = [
    ...
    { label: "Formulas", href: "/mathematics/" },
    {
      ...
      href: "/mathematics/formulas/discrete-math",
    },
    {
      label: "Laws of Propositional Logic",
      href: "/mathematics/formulas/discrete-math/laws-of-propositional-logic",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">Laws of Propositional Logic</h1>
