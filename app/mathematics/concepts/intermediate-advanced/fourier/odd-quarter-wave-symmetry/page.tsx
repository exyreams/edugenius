...
export default function OddQuaternWaveSymmetry() {
  const breadcrumbItems = [
    ...
    },
    {
      ...
      href: "/mathematics/formulas/fourier/odd-quarter-wave-symmetry",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">Odd Quarter-Wave Symmetry</h1>
