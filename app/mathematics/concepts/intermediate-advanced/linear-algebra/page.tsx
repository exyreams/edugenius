...
//     { label: "Linear Algebra", href: "/mathematics/formulas/linear-algebra" },
//   ];
//
//   return (
...
//           return (
//             <Link
//               href={`/mathematics/formulas/linear-algebra/${formula.id}`}
//               key={formula.id}
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {formulas.map((formula) => {
          ...
          return (
            <Link
              href={`/mathematics/concepts/linear-algebra/${formula.id}`}
              key={formula.id}
