...
export default function ParabolaWithVertex() {
  const breadcrumbItems = [
    ...
    {
      label: "Parabola with Vertex different from the Origin",
      href: "/mathematics/formulas/geometry/parabola-with-vertex-different-from-the-origin",
    },
  ];
