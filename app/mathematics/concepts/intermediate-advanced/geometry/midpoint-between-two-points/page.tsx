...
export default function MidpointsBetweenTwoPoints() {
  const breadcrumbItems = [
    ...
    },
    {
      ...
      href: "/mathematics/formulas/geometry/midpoint-between-two-points",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">Midpoint Between Two Points</h1>
