...
export default function EllipseWithDifferentCenterOfOrigin() {
  const breadcrumbItems = [
    ...
    {
      label: "Ellipse with Center different from the Origin",
      href: "/mathematics/formulas/geometry/ellipse-with-different-center-of-origin",
    },
  ];
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">
        Ellipse with Center different from the Origin
      </h1>
