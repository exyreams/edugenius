...
export default function SeparableDifferentialEquations() {
  const breadcrumbItems = [
    ...
    {
      label: "Separable Differential Equation",
      href: "/mathematics/formulas/differential-equations/separable-differential-equation",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">Separable Differential Equation</h1>
