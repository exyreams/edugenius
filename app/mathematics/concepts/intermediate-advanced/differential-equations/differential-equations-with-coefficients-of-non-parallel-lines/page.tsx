...
export default function DifferentialEquationsWithCoefficientsOfNonParallelLines() {
  const breadcrumbItems = [
    ...
    {
      label: "Differential Equations with Coefficients of Non-Parallel Lines",
      href: "/mathematics/formulas/differential-equations/differential-equations-with-coefficients-of-non-parallel-lines",
    },
  ];
