...
export default function DifferentialEquationsWithConstantCoefficients() {
  const breadcrumbItems = [
    ...
    {
      label: "Differential Equations with Constant Coefficients",
      href: "/mathematics/formulas/differential-equations/differential-equations-with-constant-coefficients",
    },
  ];
