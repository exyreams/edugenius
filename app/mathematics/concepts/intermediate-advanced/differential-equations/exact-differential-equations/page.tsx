...
export default function ExactDifferentialEquations() {
  const breadcrumbItems = [
    ...
    {
      label: "Exact Differential Equations",
      href: "/mathematics/formulas/differential-equations/exact-differential-equations",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">Exact Differential Equations</h1>
