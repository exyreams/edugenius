...
export default function DifferentialEquationsWithCoefficientsOfParallelLines() {
  const breadcrumbItems = [
    ...
    {
      label: "Differential Equations with Coefficients of Parallel Lines",
      href: "/mathematics/formulas/differential-equations/differential-equations-with-coefficients-of-parallel-lines",
    },
  ];
