...
export default function FirstOrderLinearDifferentialEquations() {
  const breadcrumbItems = [
    ...
    {
      label: "First-Order Linear Differential Equation",
      href: "/mathematics/formulas/differential-equations/first-order-linear-differential-equation",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">First-Order Linear Differential Equation</h1>
