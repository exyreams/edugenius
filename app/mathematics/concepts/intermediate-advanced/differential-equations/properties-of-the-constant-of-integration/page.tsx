...
export default function PropertiesOfConstantOfIntegration() {
  const breadcrumbItems = [
    ...
    {
      label: "Properties of the Constant of Integration",
      href: "/mathematics/formulas/differential-equations/properties-of-the-constant-of-integration",
    },
  ];
