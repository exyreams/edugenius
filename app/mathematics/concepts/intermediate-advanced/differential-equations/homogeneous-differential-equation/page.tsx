...
export default function HomogeneousDifferentialEquations() {
  const breadcrumbItems = [
    ...
    },
    {
      ...
      href: "/mathematics/formulas/differential-equations/homogeneous-differential-equation",
    },
  ];

  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <h1 className="heading mb-8">Homogeneous Differential Equation</h1>
